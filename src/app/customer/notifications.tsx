...
import { ArrowLeft, Bell, Star, Truck, Calendar } from 'lucide-react-native';
...
export default function CustomerNotifications() {
  ...
  // Premium mock notifications
  const notifications = [
    {
      id: '1',
      type: 'SHIPPING',
      title: 'Katering Sedang Dikirim 🛵',
      body: 'Pesanan Ayam Goreng Penyet dari Warung Bu Kris sedang menuju lokasimu. Estimasi sampai pukul 12:00 WIB.',
    ...
    },
    {
      id: '2',
      type: 'REVIEW',
      title: 'Beri Ulasan Masakanmu ⭐',
      body: 'Gimana rasa Bebek Bakar Madu kemarin? Tulis ulasanmu sekarang dan dapatkan poin katering!',
    ...
    },
    {
      id: '3',
      type: 'MENU_UPDATE',
      title: 'Menu Baru Besok Ditambahkan 📅',
      body: 'Dapur Sehat Organik menambahkan menu Chicken Caesar Salad untuk tanggal besok. Buruan pre-order sebelum kehabisan kuota!',
  ...
  return (
    <SafeAreaView className="flex-1 bg-slate-50 dark:bg-slate-950" edges={['top', 'left', 'right']}>
      ...
      <View className="bg-green-600 px-5 py-4 flex-row items-center">
        ...
        <Text className="text-white text-lg font-extrabold flex-1">Notifikasi</Text>
      </View>
      ...
      <ScrollView className="flex-1 p-4" showsVerticalScrollIndicator={false}>
        {notifications.length === 0 ? (
          <View className="flex-1 items-center justify-center py-20">
            ...
            <Text className="text-slate-400 text-sm mt-3">Tidak ada notifikasi baru</Text>
          </View>
        ) : (
