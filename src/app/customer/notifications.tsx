...
import { ArrowLeft, Bell, Star, Truck, Calendar, CheckSquare } from 'lucide-react-native';
    ...
    <SafeAreaView className="flex-1 bg-slate-50 dark:bg-slate-950" edges={['top', 'left', 'right']}>
      ...
      <View className="bg-green-600 px-5 py-4 flex-row items-center">
        ...
        <View className="flex-1">
          <Text className="text-white text-lg font-extrabold">Notifikasi</Text>
          {unreadCount > 0 && (
        ...
        <ScrollView className="flex-1 p-4" showsVerticalScrollIndicator={false}>
          {notifications.length === 0 ? (
            <View className="flex-1 items-center justify-center py-20">
              ...
              <Text className="text-slate-400 text-sm mt-3 font-semibold">Tidak ada notifikasi baru</Text>
            </View>
          ) : (
